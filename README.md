...
app.cfgは、お客様が必要に応じて値を変更できます。
以下の定義に対して、最小値から最大値の範囲で設定することができます。
なお、定義名を変更された場合は、内容が反映されません。
最小値、最大値の値はT.B.D

定義名| デフォルト値 |最小値 | 最大値 | 内容 
------------- |  ------------- | ------------- | ------------- | -------------
MD_THRESHOLD |  5 | 1 | 100 | 値が小さいほど動体検知の感度が良くなります
THRE_RECT_MIN_W |  5 | 1 | 画像サイズの最大幅 |  矩形最小幅(*2)
THRE_RECT_MIN_H |  5 | 1 | 画像サイズの最大高さ |  矩形最小高さ(*2)
...
(*2) 幅 = THRE_RECT_MIN_W, 高さ = THRE_RECT_MIN_H 未満のサイズの矩形は描画しません。
